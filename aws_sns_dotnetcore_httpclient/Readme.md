...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *aws_sns_dotnetcore_httpclient*):

Restore dependencies
```
    cd "aws_sns_dotnetcore_httpclient"
    dotnet restore
```

Execute unit tests
```
    cd "aws_sns_dotnetcore_httpclient/test/aws_sns_dotnetcore_httpclient.Tests"
    dotnet test
```

Deploy application
```
    cd "aws_sns_dotnetcore_httpclient/src/aws_sns_dotnetcore_httpclient"
